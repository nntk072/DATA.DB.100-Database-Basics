...
-- Retrieve the following information of artists and their artworks, that have been in at least one exhibition: the year and name of the exhibition where the artwork has been, artist’s first and last name and the name of the artwork.
-- Sort the result rows in ascending order by exhibition year, artist’s last name and the artwork name.
-- | year | exhibition_name | first_name | last_name | artwork_name |  
