...
-- Retrieve the following information for works that have been featured in only one exhibition: the work ID, name, technique, and artist’s first and last name.
-- Sort the result rows in ascending order by artwork ID.

-- Result column names:
-- artwork_id | artwork_name | technique | first_name | last_name
